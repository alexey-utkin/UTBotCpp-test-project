...
bin : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/lib/structures/structs/__simple_structs_shared.mk bin
build : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/lib/structures/structs/__simple_structs_shared.mk build || $(MAKE) -f $(PROJECT_DIR)/tests/lib/structures/structs/__simple_structs_obj.mk build
run : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/lib/structures/structs/__simple_structs_shared.mk build && { $(MAKE) -f $(PROJECT_DIR)/tests/lib/structures/structs/__simple_structs_shared.mk run; exit $$?; } || { $(MAKE) -f $(PROJECT_DIR)/tests/lib/structures/structs/__simple_structs_obj.mk build && { $(MAKE) -f $(PROJECT_DIR)/tests/lib/structures/structs/__simple_structs_obj.mk run; exit $$?; } }
clean : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/lib/structures/structs/__simple_structs_shared.mk clean
	$(MAKE) -f $(PROJECT_DIR)/tests/lib/structures/structs/__simple_structs_obj.mk clean
