...
extern "C" int f_src_simple_calc_c(int a);
static int f(int a) {
return f_src_simple_calc_c(a);
}
extern "C" int other_module_call_src_simple_calc_c(int a);
static int other_module_call(int a) {
return other_module_call_src_simple_calc_c(a);
}
