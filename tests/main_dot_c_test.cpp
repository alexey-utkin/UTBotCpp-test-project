...
TEST(regression, main_test_6)
{
    ...
    int actual = main(2, argv);
    EXPECT_EQ(8, actual);
    char expected_argv[2][2] = {{'b', 'c'}, {'8', 'A'}};
...
TEST(regression, main_test_7)
{
    ...
    EXPECT_EQ(1, actual);
    char expected_argv[2][2] = {{'b', 'c'}, {'b', 'c'}};
