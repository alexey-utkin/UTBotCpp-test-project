    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_2_0 = 0; it_2_0 < 10; it_2_0 ++) {
                klee_prefer_cex(_f_symbolic, _f_symbolic[it_2_0] >= -10  & _f_symbolic[it_2_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_3_0 = 0; it_3_0 < 10; it_3_0 ++) {
                klee_prefer_cex(_other_module_call_symbolic, _other_module_call_symbolic[it_3_0] >= -10  & _other_module_call_symbolic[it_3_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
