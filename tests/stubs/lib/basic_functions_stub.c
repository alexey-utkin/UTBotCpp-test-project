    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_14_0 = 0; it_14_0 < 10; it_14_0 ++) {
                klee_prefer_cex(_max__symbolic, _max__symbolic[it_14_0] >= -10  & _max__symbolic[it_14_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_15_0 = 0; it_15_0 < 10; it_15_0 ++) {
                klee_prefer_cex(_min_symbolic, _min_symbolic[it_15_0] >= -10  & _min_symbolic[it_15_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_16_0 = 0; it_16_0 < 10; it_16_0 ++) {
                klee_prefer_cex(_sqr_positive_symbolic, _sqr_positive_symbolic[it_16_0] >= -10  & _sqr_positive_symbolic[it_16_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
    ...
    static int cntCall = 0;
        ...
        if (firstTimeCall == 1) {
            ...
            for (int it_17_0 = 0; it_17_0 < 10; it_17_0 ++) {
                klee_prefer_cex(_simple_loop_symbolic, _simple_loop_symbolic[it_17_0] >= -10  & _simple_loop_symbolic[it_17_0] <= 10);
            }
        }
    #endif
    if (cntCall == 10) {
